...
const SocketClubs = module.exports;

SocketClubs.before = async (socket, method, data) => {
	if (!data) {
		throw new Error('[[error:invalid-data]]');
	}
};

SocketClubs.addMember = async (socket, data) => {
...
SocketClubs.accept = async (socket, data) => {
	await isOwner(socket, data);
...
SocketClubs.reject = async (socket, data) => {
	await isOwner(socket, data);
...
SocketClubs.acceptAll = async (socket, data) => {
	await isOwner(socket, data);
	await acceptRejectAll(SocketClubs.accept, socket, data);
};

SocketClubs.rejectAll = async (socket, data) => {
	await isOwner(socket, data);
	await acceptRejectAll(SocketClubs.reject, socket, data);
};
...
SocketClubs.issueInvite = async (socket, data) => {
	await isOwner(socket, data);
...
SocketClubs.issueMassInvite = async (socket, data) => {
	await isOwner(socket, data);
...
SocketClubs.rescindInvite = async (socket, data) => {
	await isOwner(socket, data);
	await groups.rejectMembership(data.groupName, data.toUid);
};

SocketClubs.acceptInvite = async (socket, data) => {
...
SocketClubs.rejectInvite = async (socket, data) => {
	await isInvited(socket, data);
...
SocketClubs.kick = async (socket, data) => {
	await isOwner(socket, data);
...
SocketClubs.search = async (socket, data) => {
...
SocketClubs.loadMore = async (socket, data) => {
...
SocketClubs.searchMembers = async (socket, data) => {
	if (!data.groupName) {
		throw new Error('[[error:invalid-data]]');
	}
...
SocketClubs.loadMoreMembers = async (socket, data) => {
...
SocketClubs.cover.update = async (socket, data) => {
	if (!socket.uid) {
		throw new Error('[[error:no-privileges]]');
	}
...
SocketClubs.cover.remove = async (socket, data) => {
	if (!socket.uid) {
		throw new Error('[[error:no-privileges]]');
	}
